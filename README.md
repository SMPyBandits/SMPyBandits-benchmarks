...
<a href="https://perso.crans.org/besson/phd/SMPyBandits-benchmarks/"><img width="50%" src="screenshots/screenshot_homepage.png"></a>
...
[![Open Source? Yes!](https://badgen.net/badge/Open%20Source%20%3F/Yes%21/blue?icon=github)](https://github.com/SMPyBandits/SMPyBandits-benchmarks/)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://GitHub.com/SMPyBandits/SMPyBandits-benchmarks/graphs/commit-activity)
[![Ask Me Anything !](https://img.shields.io/badge/Ask%20me-anything-1abc9c.svg)](https://GitHub.com/Naereen/ama)
[![Analytics](https://ga-beacon.appspot.com/UA-38514290-17/github.com/SMPyBandits/SMPyBandits-benchmarks/README.md?pixel)](https://GitHub.com/SMPyBandits/SMPyBandits-benchmarks/)
...
[![Stars of https://github.com/SMPyBandits/SMPyBandits-benchmarks/](https://badgen.net/github/stars/SMPyBandits/SMPyBandits)](https://GitHub.com/SMPyBandits/SMPyBandits-benchmarks/stargazers)
[![Releases of https://github.com/SMPyBandits/SMPyBandits-benchmarks/](https://badgen.net/github/release/SMPyBandits/SMPyBandits)](https://github.com/SMPyBandits/SMPyBandits-benchmarks/releases)
...
![Rewards for different algorithms, as function of nb of arms (for fixed horizon T)](screenshots/reward_functions_of_K.png)

As a function of horizon (for fixed nb of arms K)
![Rewards for different algorithms, as a function of horizon (for fixed nb of arms K)](screenshots/reward_functions_of_T.png)

### Memory consumption of different algorithms
(not sure yet if I wrote this one correctly, I don't understand the plot)
![Memory consumption of different algorithms](screenshots/memory.png)

### Time complexity of different algorithms
![Time complexity of different algorithms](screenshots/time.png)

### Best arm selection rate of different algorithms
For three different values of K
![Best arm selection rate of different algorithms](screenshots/best-arm-rate.png)
...
## :scroll: License ? [![GitHub license](https://img.shields.io/github/license/SMPyBandits/SMPyBandits.svg)](https://github.com/SMPyBandits/SMPyBandits-benchmarks/blob/master/LICENSE)
[MIT Licensed](https://lbesson.mit-license.org/) (file [LICENSE](LICENSE)).

© 2016-2019 [Lilian Besson](https://GitHub.com/Naereen), with help [from contributors](https://github.com/SMPyBandits/SMPyBandits-benchmarks/graphs/contributors).
